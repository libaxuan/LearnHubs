...
<li><a href="http://scrapy-chs.readthedocs.io/zh_CN/latest/intro/tutorial.html#intro-tutorial" target="_blank" rel="noopener noreferrer">Scrapy 入门<ExternalLinkIcon/></a><br>
...
<p>优先级：not &gt; and &gt; or<br>
not 1 or 0 and 1 or 3 and 4 or 5<br>
(not 1) or (0 and 1) or (3 and 4) or 5</p>
<figure><img src="https://img.gpt-vip.top/2022-06-29-18-18-44.png?imageMogr2/format/webp" alt="Python 运算符优先级" tabindex="0" loading="lazy"><figcaption>Python 运算符优先级</figcaption></figure>
