...
<ul>
<li><a href="https://wyagd001.github.io/v2/docs" target="_blank" rel="noopener noreferrer">AutoHotkey 中文说明<ExternalLinkIcon/></a>：<a href="https://wyagd001.github.io/v2/docs/KeyList.htm" target="_blank" rel="noopener noreferrer">按键 Key 名列表<ExternalLinkIcon/></a>，<a href="https://wyagd001.github.io/v2/docs/Variables.htm#BuiltIn" target="_blank" rel="noopener noreferrer">AHK 环境变量<ExternalLinkIcon/></a>。</li>
...
<tr>
<td>`</td>
<td>转义字符，参考<a href="https://wyagd001.github.io/v2/docs/misc/EscapeChar.htm" target="_blank" rel="noopener noreferrer">转义序列<ExternalLinkIcon/></a></td>
</tr>
<tr>
<td>;</td>
<td>代表注释内容，不影响函数</td>
...
<p>对于可执行文件，命令 <code v-pre>Run *RunAs</code> 相当于右键菜单的「以管理员权限运行」命令。</p>
<p>右键单击脚本的快捷方式，选择「属性」&gt;「高级」，勾选「用管理员身份运行」，只能用于手动开启，开机启动会忽略带管理器的启动项。</p>
...
<p>如果<strong>管理员有设密码</strong>，则可使用下列命令，用管理员权限打开脚本。</p>
