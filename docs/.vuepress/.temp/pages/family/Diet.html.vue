<template><div><p>16:8 断时法：每天 8 小时进食，8 点钟早餐，3 点后禁食。</p>
<ul>
<li>早餐：燕麦牛奶 + 坚果、桃李面包 + 鲜牛奶。每天 3 个坚果（纸核桃）。</li>
<li>午餐：沙拉 + 鸡蛋 + 白肉（鸡、鸭、鱼）。</li>
<li>晚餐：6 点停止进食，饿了吃苹果、沙拉、鸡蛋，鸡蛋只吃蛋白。</li>
</ul>
<h2 id="饮食" tabindex="-1"><a class="header-anchor" href="#饮食" aria-hidden="true">#</a> 饮食</h2>
<h3 id="零食" tabindex="-1"><a class="header-anchor" href="#零食" aria-hidden="true">#</a> 零食</h3>
<ul>
...
<h3 id="饮料" tabindex="-1"><a class="header-anchor" href="#饮料" aria-hidden="true">#</a> 饮料</h3>
...
<h3 id="冷泡燕麦" tabindex="-1"><a class="header-anchor" href="#冷泡燕麦" aria-hidden="true">#</a> 冷泡燕麦</h3>
<p>牛奶/酸奶/燕麦奶/椰奶 + 燕麦，前一天晚上配好，放在密封容器里，冰箱冷藏。第二天拿出来再加配料（奇亚籽、坚果、果干、椰子片、即食燕麦、水果、酸奶块）即可食用。需要注意的有几个点：</p>
<ul>
<li>主材一定要用生燕麦或烤燕麦，不要用即食的，即食的泡一夜就变成糊了，既不好吃也不健康，升糖很高。</li>
<li>配料之所以在吃前再添加是为了避免口感拉胯，所以不会带来脆的口感的配料也可以冷藏前添加，即食燕麦片、椰子片、坚果、酸奶块这些可以丰富口感的建议在吃前添加。</li>
<li>配料有两个作用，除了提升口感层次还有丰富营养的作用，但建议酌情添加，特别是有减脂需求的人士，毕竟大部分配料都是热量炸弹。而且不加配料其实已经很好吃了，个人较为推荐的配料是一袋每日坚果或一小把燕麦脆片（如卡乐比）。</li>
<li>容器可以选用梅森杯、玻璃饭盒，若对配料有要求而且想路上吃可以选择乐扣双层多用保鲜盒。</li>
<li>放冰箱这一步很重要！不放可能会化身喷射战士。</li>
<li>唯一的缺点就是冷吃可能不是所有人都适合，也可以早上再用微波炉打一下，对口感和营养肯定会有影响。</li>
</ul>
<h2 id="健康理论" tabindex="-1"><a class="header-anchor" href="#健康理论" aria-hidden="true">#</a> 健康理论</h2>
<h3 id="程序员延寿指南" tabindex="-1"><a class="header-anchor" href="#程序员延寿指南" aria-hidden="true">#</a> 程序员延寿指南</h3>
...
<p>浸泡 42℃ 以上的水温最多泡 3-5 分钟，40℃ 可以泡 10 分钟，37℃ 到 39℃ 的温水，可以泡 20-30 分钟。泡浴后的清水冲淋是有必要的，头发部位和面部用冷水冲淋则有极其良好的保健和延缓衰老的功效。</p>
<p>泡浴作用：</p>
<ul>
