<template><div><p>Emby 为家庭提供了一个强大的媒体服务器，但在配置过程中，记得为你的媒体库目录授权“Everyone”，以确保 Emby 能够无障碍地访问它。为此，请打开共享文件夹的权限设置，选择对应的系统用户，并确保其具有读写权限。</p>
<p>使用 Emby 客户端播放视频需要 Emby Premiere。一次性购买终身会员的价格为 119 美元，但在黑五期间，通常可以以 99 美元的折扣价格获得。</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token comment"># https://hub.docker.com/r/linuxserver/emby</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安全地从外部访问" tabindex="-1"><a class="header-anchor" href="#安全地从外部访问" aria-hidden="true">#</a> 安全地从外部访问</h2>
<p>如果你计划从外部访问 Emby，请务必启用 HTTPS。具体步骤可以参考<a href="https://www.bilibili.com/read/cv14814465/" target="_blank" rel="noopener noreferrer">这里<ExternalLinkIcon/></a>。简单来说：</p>
<ol>
<li>确保你的家庭网络已设置了 DDNS（通常通过路由器完成）。</li>
<li>下载与你的域名匹配的 Tomcat 证书版本。</li>
<li>解压后，你会看到一个 pfx 文件和一个包含密码的 txt 文件。</li>
<li>将它们都放置在 config 目录的特定路径中。</li>
<li>接下来，在 Emby 的“服务器 &gt; 网络”设置中，输入你的公共端口和 DDNS 域名。</li>
<li>建议开启安全连接模式，这样可以更好地保护你的数据安全。</li>
</ol>
<figure><img src="https://img.gpt-vip.top/2023-09-15-05-32-43.png?imageMogr2/format/webp" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</div></template>
